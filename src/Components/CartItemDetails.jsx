    ...
    <Card>
      <div>
        ...
        <Card.Summary>
          ...
          <Card.UnitPrice>@ ${cartItem.price.toFixed(2)}</Card.UnitPrice>
          <Card.TotalPrice>${(cartItem.price * cartItem.qte).toFixed(2)}</Card.TotalPrice>
        </Card.Summary>
      </div>
      <div>
...
function ModalCard({ cartItem }) {
  return (
    <Card>
      ...
      <div>
        <Card.SubTitle>${(cartItem.price * cartItem.qte).toFixed(2)}</Card.SubTitle>
      </div>
    </Card>
  );
}
